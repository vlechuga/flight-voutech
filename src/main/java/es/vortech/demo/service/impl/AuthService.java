...
import es.vortech.demo.security.JwtService;
import es.vortech.demo.security.TokenDto;
import es.vortech.demo.entity.Token;
...
public class AuthService {
    ...
    public TokenDto register(final RegisterRequest request) {
    ...
    public TokenDto authenticate(final AuthDto request) {
    ...
    public TokenDto refreshToken(@NotNull final String authentication) {
